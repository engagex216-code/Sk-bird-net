  ...
  <div class="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-10">
    <div>
      ...
      <ul class="space-y-2 text-sm">
        <li class="flex items-start gap-2"><i data-lucide="map-pin" class="w-4 h-4 mt-0.5"></i>1140 Sector, Delhi NCR, India</li>
...
<section class="max-w-5xl mx-auto px-6 py-14 grid md:grid-cols-2 gap-10 items-center">
  ...
  <div class="space-y-4">
    <div class="flex items-start gap-3">
      ...
      <p class="text-sm text-gray-600">1140 Sector, Delhi NCR, India</p>
    </div>
    <div class="flex items-start gap-3">
